...
use alphathinkyyl\WeWorkApi\api\struct\Agent;
use alphathinkyyl\WeWorkApi\api\struct\ApprovalData\ApprovalDataList;
use alphathinkyyl\WeWorkApi\api\struct\batch\Batch;
use alphathinkyyl\WeWorkApi\api\struct\batch\BatchJobArgs;
use alphathinkyyl\WeWorkApi\api\struct\CheckinData\CheckinDataList;
use alphathinkyyl\WeWorkApi\api\struct\CheckinOption\CheckinOption;
use alphathinkyyl\WeWorkApi\api\struct\ExternalContact\WelcomeMsg;
use alphathinkyyl\WeWorkApi\api\struct\invoice\BatchGetInvoiceInfoReq;
use alphathinkyyl\WeWorkApi\api\struct\invoice\BatchUpdateInvoiceStatusReq;
use alphathinkyyl\WeWorkApi\api\struct\menu\Menu;
use alphathinkyyl\WeWorkApi\api\struct\message\Message;
use alphathinkyyl\WeWorkApi\api\struct\oauth\UserDetailByUserTicket;
use alphathinkyyl\WeWorkApi\api\struct\oauth\UserInfoByCode;
use alphathinkyyl\WeWorkApi\api\struct\pay\PayWwSptrans2PocketReq;
use alphathinkyyl\WeWorkApi\api\struct\pay\QueryWorkWxRedpackReq;
use alphathinkyyl\WeWorkApi\api\struct\pay\QueryWwSptrans2PocketReq;
use alphathinkyyl\WeWorkApi\api\struct\pay\SendWorkWxRedpackReq;
use alphathinkyyl\WeWorkApi\api\struct\tag\Tag;
use alphathinkyyl\WeWorkApi\api\struct\user\User;
...
use alphathinkyyl\WeWorkApi\utils\error\SysError;
use alphathinkyyl\WeWorkApi\utils\Redis;
use alphathinkyyl\WeWorkApi\utils\Utils;
use alphathinkyyl\WeWorkApi\api\struct\Department;
...
class CorpAPI extends API
{
     ...
     */
    public function __construct($corpId = null, $secret = null, \alphathinkyyl\WeWorkApi\api\struct\Redis $redis = null)
    {
